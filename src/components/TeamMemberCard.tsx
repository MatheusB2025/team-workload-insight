  ...
  return (
    <div className="border-t pt-6 pb-4">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center">
          <Avatar className="mr-2 h-10 w-10">
            <AvatarFallback className="bg-purple text-white">{member.initials}</AvatarFallback>
          </Avatar>
          <div>
      ...
      <div className="space-y-4">
            ...
            <div className="flex gap-2">
              {(["Seg", "Ter", "Qua", "Qui", "Sex"] as Day[]).map((day) => (
                <button
                  ...
                  className={`day-pill ${
                    task.days.includes(day) ? dayColors[day] : "bg-gray-200 text-gray-600"
                  }`}
                >
                  {day}
                </button>
        ...
        >
          <UserPlus className="mr-2 h-4 w-4" /> Adicionar tarefa
        </Button>
      </div>
